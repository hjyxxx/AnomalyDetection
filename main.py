...
from utils.logging import load_config, load_args
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='TFWModel', help='模型名称')
    parser.add_argument('--train-epochs', type=int, default=50, help='训练轮数')
    parser.add_argument('--use-gpu', type=bool, default=True, help='是否使用GPU')
    parser.add_argument('--gpu', type=int, default=0, help='使用第几个GPU')

    # 模型参数
    parser.add_argument('--e-layers', type=int, default=6, help='')
    ...
    parser.add_argument('--embedding-channels', type=int, default=128, help="嵌入维度")
    parser.add_argument('--d-ff', type=int, default=32, help='')
    parser.add_argument('--patch_len', type=int, default=10, help="")
    parser.add_argument('--patch_stride', type=int, default=1, help="")
    parser.add_argument('--patch_padding', type=int, default=0, help="")
    parser.add_argument('--dropout', type=float, default=0.0, help='')
    parser.add_argument('--fusion', type=str, default='t', help="时域/频域/小波域, tfw")

    # 数据集参数
    parser.add_argument('--data', type=str, default='asd2', help='数据集名称')
